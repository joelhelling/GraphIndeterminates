...
public class MatrixHeuristic {
    ...
    private MatrixHeuristic(NeighborhoodComparator neighborhoodComparator, int depth) {
        this.neighborhoodComparator = neighborhoodComparator;
        this.depth = depth;
    }

    public static MatrixHeuristic ascendingNeighborhood(int depth) {
        return new MatrixHeuristic(new NeighborhoodAscendingComparator(), depth);
    }

    public static MatrixHeuristic descendingNeiborhood(int depth) {
        return new MatrixHeuristic(new NeighborhoodDescendingComparator(), depth);
    }
